...
function LoadPreview(ProposalId) {
    ...
    if (ProposalId != null && ProposalId != "" && ProposalId != undefined) {
        ...
        JudgesViewEveryMonthMoney("Assessment/GetmoneyList", ProposalId, "LifeEducationPlan");
        //教育配套
        //消费规划
        //加载每月可支配资金 可用资产
        GetConsumptionPlan(ProposalId);
        JudgesViewEveryMonthMoney("Assessment/GetmoneyList", ProposalId, "ConsumptionPlan");
        //创业规划
        GetStartAnUndertakingPlanList(ProposalId);
        JudgesViewEveryMonthMoney("Assessment/GetmoneyList", ProposalId, "StartAnUndertakingPlan");
        //退休规划

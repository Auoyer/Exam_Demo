...
function GetStartList() {
    ...
    pageHelper.Init({
        url: "/CompetitionJudges/StatisticAlanalysis/MatchList2",
        type: "POST",
        pageDiv: "#pages",
        data: {
            name: $("#searchName").val(),
        ...
        bind: function (data) {
            ...
            $(data.Data).each(function (index, dom) {
                ...
                if (dom.IsRelease == 2) {
                    trHtml += "<a class=\"d_chakan\" href=\"/CompetitionJudges/StatisticAlanalysis/Detail/{5}\">查看</a>";
                }
                else {
...
function GetModel() {
    // 加载编辑页面
    $.ajax({
        url: '/CompetitionJudges/StatisticAlanalysis/GetModel',
        data: {
            id: $('#hideMatchId').val()
        },
...
function GetStatistic() {
    ...
    var series = [];
    $.ajax({
        url: "/CompetitionJudges/StatisticAlanalysis/GetUserMatchScoreList",

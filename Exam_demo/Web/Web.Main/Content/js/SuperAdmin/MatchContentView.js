...
function LodingTestPapers(PapersId) {
    ...
    $.ajax({
        url: "/Admin/Paper/GetTestPapersInfo",
        async: false,
        type: "POST",
        ...
        success: function (data) {
            if (data != null && data.Data != null) {
                ...
                if (curData.ScoreInfo != null && curData.ScoreInfo.length > 0) {
                    ...
                    $("#btnEditQuestions").attr("href", "/Admin/Paper/TheoryPaperAdd?Status=Edit&PapersId=" + PapersId + "&MatchId=" + MatchId + "&MatchType=" + MatchType);
                ...
                $("#addMatchPaper").attr("href", "/Admin/Paper/TheoryPaperAdd?Status=Add&MatchId=" + MatchId + "&MatchType=" + MatchType);
...
function LodingTrainCase(MatchId) {
    pageHelper.Init({
        url: "/Admin/Paper/GetTrainExamWithDetail",
        type: "POST",
        pageDiv: "#CasePage",
        data:
        {
...
function EditQuestionsLoading() {
    ...
    dialogHelper.Show('popQuestionBankList', 800);
    //题型下拉列表   
    selectHelper.GetSelect({
        url: "/Admin/Paper/TiXingSelList",
        Id: "#TiXingSel",
        value: "全部",
...
function SelectTrainExam(TrainExamId) {
    $.ajax({
        url: "/Admin/Paper/LoadingTrainExam",
        async: false,
        type: "POST",
        data: {
            Id: TrainExamId,

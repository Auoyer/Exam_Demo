...
function GetPaperDetailList(Id, LibraryId, questionType, pageIndex, questionTypeId, optAsync) {
    ...
    $.ajax({
        url: "/CompetitionAdmin/Paper/GetPaperDetailList",
        async: false,
        type: "POST",
        data: {
...
function GetQuestion(PaperId, LibraryId, questionType, questionId) {
    ...
    var UserId = $.getUrlParam("UserId");
    $.ajax({
        url: "/CompetitionAdmin/Paper/GetQuestion",
        type: "POST",
        async: false,
        dataType: "json",
        crossDomain: false,
...
function GetTimes(async, Id) {
    $.ajax({
        url: "/CompetitionAdmin/Paper/GetExamTimes",
        type: "POST",
        async: async,
        dataType: "json",
        crossDomain: false,
...
function DownLoad(path, name, Id) {
    ...
    location.href = "/CompetitionAdmin/Paper/DownloadFile?path=" + encodeURIComponent(path) + "&name=" + encodeURIComponent(name) + "&randomId=" + Math.random();
...
function LookOver(Id) {
    var UserId = $.getUrlParam("UserId");
    $.ajax({
        url: "/CompetitionAdmin/Paper/GetPaperDetail",
        async: false,
        type: "POST",
        data: {
            Id: Id,
